...
const Dropdown = () => {
  ...
  return (
    <div className="sm:bg-white sm:h-screen sm:z-30  sm:fixed sm:top-0 sm:w-screen  sm:flex sm:flex-col sm:items-center transform opacity-100 group-hover:translate-x-12 ">
      <div className=" sm:w-full sm:flex sm:justify-end pr-8 sm:text-end">
