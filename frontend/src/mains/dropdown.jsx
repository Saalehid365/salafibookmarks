...
const Dropdown = () => {
  ...
  return (
    <div className="sm:bg-white sm:h-96 sm:fixed sm:w-screen  sm:flex sm:flex-col transform opacity-100 group-hover:translate-x-12">
      <div className="sm:flex sm:justify-end pr-8 ">
