...
const Topsellercard = (props) => {
  ...
  return (
    <div>
      <div class="w-80 bg-white shadow rounded hover:scale-105 hover:transform sm:w-72 sm:h-42">
        ...
        <div class="p-4 flex flex-col items-center">
          ...
          <h1 class="text-gray-800 w-full text-center mt-1 text-ellipsis whitespace-nowrap overflow-hidden">
            {product.Quote}
          </h1>
