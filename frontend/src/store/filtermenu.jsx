...
const Filtermenu = () => {
  ...
  return (
    <div className="w-1/5 border-r-2 font-serif sm:w-screen sm:h-20 sm:border-none">
      <div className="h-40  flex flex-col items-start pt-6 pl-6 border-b-4 sm:flex sm:flex-row sm:items-center sm:h-32 sm:pt-0 sm:justify-evenly sm:w-96 sm:border-0">
        <FaSort />
        <h2>Sort by</h2>
